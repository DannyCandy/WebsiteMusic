...
const DeleteAlbumDialog = () => {
    ...
    const { deleteAlbum } = useAdminMusicStore();
	...
	const handleConfirmDelete = async () => {
        ...
        const promise = axiosInstance
            .delete(`/admin/albums/${idToDelItem}`)
            .then((response) => {
                if (response.status === 200) {
                    closeDialog();
                    deleteAlbum(idToDelItem);
                    resetIdToDelItem();
                }
            }) .catch((err) => {
    ...
    return (
        <AlertDialog open={isOpen && type === "deleteAlbum"} onOpenChange={handleOpenChange}>
            <AlertDialogContent className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
                <AlertDialogHeader className="text-center">
                    ...
                    <AlertDialogTitle className="text-xl font-semibold text-white">Delete album</AlertDialogTitle>
                    <AlertDialogDescription className="text-gray-300 text-base">
                        Are you sure you want to delete this<span className="font-semibold text-white">album</span>
                        <br />
